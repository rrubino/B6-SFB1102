...
ch, ids, cl = conObj.loadConfig()

from infodens.featurextractor import featureManager
featMgrObj = featureManager.FeatureManager(4,conObj.featureIDs, conObj.featargs, prepObj,1)

conObj2 = controller.Controller('testconfig2.txt')
conObj2.loadConfig()
prepObj2 = preprocess.Preprocess('testFile.txt')
featMgrObj2 = featureManager.FeatureManager(4,conObj2.featureIDs, conObj2.featargs, prepObj2, 1)
